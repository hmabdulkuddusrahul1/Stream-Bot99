        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://graph.org/file/f86d1e95f4986e2befc27.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<b>ꜱᴏᴍᴇᴛʜɪɴɢ  ᴡᴇɴᴛ  ᴡʀᴏɴɢ  <a href='https://telegram.me/Zenitsu_AF'>ᴄʟɪᴄᴋ  ʜᴇʀᴇ  ꜰᴏʀ  ꜱᴜᴘᴘᴏʀᴛ</a></b>",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ ᴄᴏɴᴛᴀᴄᴛ [ᴏᴡɴᴇʀ](https://telegram.me/Zenitsu_AF).",
                disable_web_page_preview=True)
            return
...
┃
┣⪼<b>ɴᴀᴍᴇ : <a href='https://telegram.me/Zenitsu_AF'>File to Link AG</a></b>
┣⪼<b>ꜱᴇʀᴠᴇʀ : ʜᴇʀᴜᴋᴏ</b>
┣⪼<b>ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ</b>
┣⪼<b>ᴜᴘᴅᴀᴛᴇꜱ : <a href='https://t.me/guardians_Bot_Updates'>Update Channel</a></b>
┣⪼<b>Movies : <a href='https://telegram.me/Entertainment_AG'>Movies</a></b>
┣⪼<b>Anime : <a href='https://t.me/Anime_Guardians'>Anime</a></b>
┃
<b>╰━━━━〔ᴘʟᴇᴀꜱᴇ sᴜᴘᴘᴏʀᴛ〕</b>""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Leech Group", url="https://t.me/+42fvK0LbrCc0ZGY1")],
                [InlineKeyboardButton("Update Channel", url="https://t.me/guardians_Bot_Updates")]
            ]
        )
    )
