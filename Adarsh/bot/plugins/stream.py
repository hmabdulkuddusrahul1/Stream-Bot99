    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [Zenitsu](https://telegram.me/Zenitsu_AF) he will help you.**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Update channel  [ʙᴏss](https://telegram.me/Zenitsu_AF)**",
...
<b>❇️  ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @Entertainment_AG</b>"""
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton('Anime', url='https://t.me/Anime_Guardians')]])
        )
